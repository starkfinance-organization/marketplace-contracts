...
@contract_interface
namespace IAccount {
    func isValidSignature(hash: felt, signature_len: felt, signature: felt*) {
    }
}
...
// domain: { name: "StarkSport", chainId: networkId() === "mainnet-alpha" ? "SN_MAIN" : "SN_GOERLI", version: "2" }
// hashDomain = 1161338756782444142862655110517618273593182489677642162506529284371874760008 # SN_MAIN
// hashDomain = 236103635163281937753548442662324283876136805207875374727607692885648390304 # SN_GOERLI
@view
